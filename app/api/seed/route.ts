...
export default async function handler(req: NextApiRequest, res: NextApiResponse<Data>) {
  ...
  await prisma.restaurant.createMany({
    data: [
      ...
      },
      {
        ...
        images: ['https://resizer.otstatic.com/v2/photos/xlarge/1/26646742.jpg', 'https://resizer.otstatic.com/v2/photos/xlarge/1/26646761.jpg'],
  ...
  await prisma.item.createMany({
    data: [
      ...
      {
        name: 'Shahi Tukda',
        description: 'Chef’s signature dessert : crispy bread poched with flavoured milk and topped with homemade cream made of pistachios, rose.',
        price: '$11.00',
        restaurant_id: vivaanId,
      },
      {
        name: 'Four-In-One Chicken',
        description: 'Boneless chicken breast pieces marinated with four different kind of texture and Indian spices for each piece and grilled in clay oven',
        price: '$16.99',
      ...
      {
        name: 'Prawn Tandoori',
        description: 'Large juicy prawn marinated in ginger, garlic, fresh squeezed lemon juice and along with various dry spices and grilled in clay oven',
        price: '$19.49',
        restaurant_id: RamaKrishnaId,
      },
      {
      ...
      {
        name: 'Coconut Curry',
        description: 'Choice of boneless chicken breast, lamb, beef, fish or shrimp cooked in a creamy coconut, butter and onion sauce',
        price: '15.99',
        restaurant_id: RamaKrishnaId,
      },
      {
      ...
      },
      {
        ...
        description: "Lamb chops are coated in a spicy marinade and seared. It's paired with mint chutney, mango chutney, and raita. Allergens: Meat",
        price: '16.00',
        restaurant_id: lastTrainToDelhiId,
      },
      {
        name: 'Crispy Shrimp',
        description: 'Tandoori shrimp wrapped in crispy potato accompanied by a seasonal chutney and micro greens from the garden',
        price: '$15.00',
        restaurant_id: lastTrainToDelhiId,
      },
      {
      ...
      },
      {
        ...
        description: 'Traditional Northern Italian Specialty. Slow-cooked feef stew, cooked in tomato sauce and red wine reduction, served over soft polenta',
        price: '$26.00',
        restaurant_id: stelvioId,
      },
    ],
